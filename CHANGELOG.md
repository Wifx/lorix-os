...
- [LOR-732] Constrain xdelta3 memory usage during wifx delta updates
...
- [LOR-608] Update machine-info to 1.4.0 (overall cleanup and optimization)
- [LOR-623] Add support for FRONTEND_REV in machine-info
