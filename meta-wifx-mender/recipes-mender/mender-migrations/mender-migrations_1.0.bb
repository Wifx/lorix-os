...
SRC_URI = " \
    ...
    file://0.5.0/01_UPF-hardware-config.sh;subdir=${PN}-${PV} \
    file://0.6.0/01_NetworkManager-profiles-rename.sh;subdir=${PN}-${PV} \
    file://0.6.1/01_UPF-rename-from-wpf.sh;subdir=${PN}-${PV} \
    file://1.0.0/01_Manager-config.sh;subdir=${PN}-${PV} \
    file://1.0.0/02_BasicStation-config.sh;subdir=${PN}-${PV} \
    file://1.0.1/01_Manager-config-rights-fix.sh;subdir=${PN}-${PV} \
    file://1.1.1/01_GPS-disable-if-no-coords.sh;subdir=${PN}-${PV} \
"
