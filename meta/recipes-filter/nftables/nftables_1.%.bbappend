...
do_install:append() {
    ...
    install -m 0644 ${WORKDIR}/ping.conf ${D}${NFTABLES_AVAILABLE_SET_DIR}/ping.conf
    ...
    ln -snf ${NFTABLES_AVAILABLE_SET_DIR}/ping.conf ${D}${NFTABLES_ACTIVE_SET_DIR}/10-ping.conf
    ln -snf ${NFTABLES_AVAILABLE_SET_DIR}/ssh.conf ${D}${NFTABLES_ACTIVE_SET_DIR}/20-ssh.conf
    ln -snf ${NFTABLES_AVAILABLE_SET_DIR}/http.conf ${D}${NFTABLES_ACTIVE_SET_DIR}/30-http.conf
}
