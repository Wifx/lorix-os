...
SRC_URI = " \
    ...
    file://121_Install-bootstrap-artifact.sh;subdir=${BPN}-${PV} \
    ...
    file://300_Logs-restore.sh;subdir=${BPN}-${PV} \
    file://390_Migrate-cleanup.sh;subdir=${BPN}-${PV} \
...
do_compile() {
    ...
    include_script 121_Install-bootstrap-artifact.sh    ArtifactInstall_Enter_31_install-bootstrap-artifact
    ...
    include_script 300_Logs-restore.sh                  ArtifactCommit_Enter_00_Logs-restore

    # Artifact commit leave
    include_script 390_Migrate-cleanup.sh               ArtifactCommit_Leave_90_Migrate-cleanup
    include_script 391_Opkg-configure.sh                ArtifactCommit_Leave_91_OPKG-configure
    include_script 392_Update-ca-certificates.sh        ArtifactCommit_Leave_92_Update-ca-certificates
