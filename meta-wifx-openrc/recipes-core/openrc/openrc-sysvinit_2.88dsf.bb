...
PACKAGES =+ "${PN}-pidof ${PN}-sulogin"
FILES_${PN} += "${base_sbindir}/* ${base_bindir}/*"
FILES_${PN}-pidof = "${base_bindir}/pidof.${PN} ${base_sbindir}/killall5.${PN}"
FILES_${PN}-sulogin = "${base_sbindir}/sulogin.${PN}"

RDEPENDS_${PN} += "${PN}-pidof initd-functions"
